...
纯 tkinter 桌面应用，支持 4 种地图场景 × 8 种路径规划算法，6 大功能标签页。
...
│   ├── models/                    # 数据模型 (Graph, Node, Building)
│   ├── data/                      # 校园地图 + 测试场景
│   └── tests/                     # 后端测试 (69 cases)
├── frontend/                      # Web 前端
│   └── index.html                 # Canvas SPA
├── desktop/                       # 🆕 桌面应用 (tkinter)
│   ├── run.py                     # 桌面版入口
...
Python 3.x · Flask · HTML5 Canvas · tkinter · pytest · LaTeX
