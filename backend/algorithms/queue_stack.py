...
Explicit implementations of fundamental abstract data types used across
...
While Python's list already supports these operations, wrapping them in
explicit ADT classes demonstrates understanding of the interface/contract
separation — a key concept in data structures education.
...
class Queue:
    ...
    def dequeue(self) -> Optional[Any]:
        ...
        self._head += 1
        # Periodic compaction to avoid unbounded memory growth
