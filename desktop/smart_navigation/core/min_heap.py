...
Ported from CampusPath (min_heap.py).
This is the core data structure enabling Dijkstra's O((V+E) log V) performance.
...
class MinHeap:
    ...
    Usage:
        ...
        heap.decrease_key("room-101", 1.0)
    ...
    def push(self, priority: float, node_id: str) -> None:
        ...
        Raises ValueError if node_id is already in the heap.
        """
